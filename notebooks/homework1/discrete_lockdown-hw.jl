...
# ╔═╡ d7ed6ab9-315a-4253-81a0-195c3e68aab1
begin
	using Plots
	using PlutoUI
end

# ╔═╡ 37f8a55f-73bf-4ce5-8c24-996c627d0991
student1 = (name = "Hui Yann Foo", email = "huiyann.foo@sciencespo.fr")

# ╔═╡ 57005404-6170-11eb-3ffc-f57feda21784
# edit the code below to set your name and email

student2 = (name = "Wiktor Zielinski", email = "wiktor.zielinski@sciencespo.fr")
...
In this homework we want to make a small modification to the discrete SIR model introduced in [this notebook](https://floswald.github.io/julia-bootcamp/09-introsir.html) (in lecture 1).
...
* We will run this for 500 periods
"
...
#function discrete_lockdown

function discrete_lockdown(β, γ, ss, ii, rr, contact, TT=1000)
...
# ╔═╡ 6ea8d9a0-4e24-45b7-9ba2-1852e0ce819d
function define_lockdown(start_date, time, intensity)
	c = ones(TT)
	end_date = start_date + time
	if end_date > TT
		print("Our time span is too short... give smaller time of lockdown")
	else
		c[start_date:end_date] .= intensity
	end
	return c, start_date, end_date
end

# ╔═╡ ae1bac0d-abb2-4ff6-aadf-03dc0661fb8f
results = define_lockdown(10, 200, 0.2)

# ╔═╡ 43e187da-9a3d-43d6-9154-aea8afc3f52e
c = results[1]; start_date = results[2]; end_date = results[3]

# ╔═╡ 87f504ba-5bc1-11eb-1919-73376bbf34a0
SIR = discrete_lockdown(β,γ,ss,ii,rr,c,TT)  # define it!
...
begin
	...
	plot!([start_date, end_date], seriestype = "vline", xticks = ([start_date,end_date],["Start of lockdown", "End of lockdown"]), label = "")
...
if (student1.name == "Jazzy Jeff") || !(contains(student1.email, "@") && (student1.email == "jazzy.jeff@yahoo.com"))
